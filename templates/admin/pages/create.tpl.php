<h3 class="mb-5">Página inicial</h3>
...
<form action="" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input name="url" id="pagesUrl" type="text" class="form-control" placeholder="URL amigável, deixe em branco para informar a página inicial..." required>
        </div>
    </div>
    <div class="form-group">
